...
protected void setPaths(ArrayList<String> bootclasspaths,
	...
	if (this.releaseVersion != null && this.complianceLevel < jdkLevel) {
		...
		Classpath olderRelease = FileSystem.getOlderSystemRelease(this.javaHomeCache.getAbsolutePath(), this.releaseVersion, null);
		if (olderRelease != null) {
			allPaths.add(olderRelease);
		}
	} else {
